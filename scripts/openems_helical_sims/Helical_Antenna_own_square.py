...
Helix_turns = 6  # --> expected gain is G ~ 4 * 10 = 40 (16dBi)
Helix_pitch = 25  # --> pitch is ~ lambda/4 - MINE IS 25mm
Helix_mesh_res = 3

gnd_half_size = 65   # 130 mm / 2  (13 x 13 cm plate)
...
# create square aluminium ground plane (13 x 13 cm, 1.5 mm thick)
gnd = CSX.AddMaterial('gnd', kappa=3.77e7)  # aluminium conductivity

start = [-gnd_half_size, -gnd_half_size, -gnd_thickness]
stop  = [ gnd_half_size,  gnd_half_size,  0]
gnd.AddBox(start, stop)
